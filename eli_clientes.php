...
<script language="javascript" src="librerias/js/eliminar.js" type="text/javascript"></script>
<title>AdmiRay System</title>
</head>

<body>

<div class="titulo">Eliminar Cliente</div>
<br>
...
<form method="post" name="cliente" action="librerias/php/eli_cliente.php">
  Inserte Cedula o Rif:<input name="cod_cli" type="text" maxlength="12">&nbsp;&nbsp;
<input name="eliminar" type="image" src="imagenes/eliminar.png" width="30" height="30" />	
</form>
</body>
</html>
