function val()
{
	...
	hf+="&ced="+document.presu.cod_cli.value;
...
function subh(hf){window.location="librerias/php/deta_presu.php?"+hf}
function inser(){window.location="librerias/php/inser_pre.php?ced="+document.presu.cod_cli.value+""}