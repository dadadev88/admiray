...
<body>
<div class="titulo">Buscar Factura (Reporte)</div> 
<form method="post" action="/programas/admiray/librerias/php/bus_fact.php" name="presu"> 
<table width="900" align="center">
  <tr>
    ...
    <td valign="bottom">N&ordm; de Factura:
      <input type="text" name="cod_enc_fac" align="right" value="<?php echo $_GET['cod'];?>"/>
