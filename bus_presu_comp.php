...
<form method="post" action="librerias/php/bus_presu_com.php" name="presu"> 
<table width="900" align="center">
  <tr>
    ...
    <td valign="bottom">
Nº de Presuesto de Compra:<input name="cod_pre_comp" value="<?php echo $_GET['cod'];?>" type="text" size="10" align="right"/>&nbsp;<input width="20" height="20" type="image" src="imagenes/camera_test.png"/>
	</td>
  </tr>
  <tr>
