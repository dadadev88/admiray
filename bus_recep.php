...
<body>
<div class="titulo">Recepcion de Mercancia (Reporte)</div>
<form method="post" action="librerias/php/bus_recep.php" name="presu"> 
<table width="900" align="center">
  <tr>
    ...
    <td valign="bottom">
Nº de Recepcion:
  <input name="cod_recep" type="text" size="10" align="right"/>&nbsp;<input width="20" height="20" type="image" src="imagenes/camera_test.png"/>
	</td>
  </tr>
  <tr>
