...
<body>
<div class="titulo">Consultas de Facturas</div><br />
...
<form method="post" action="librerias/php/consul__cli_fact.php" name="presu"> 
...
<center>Cliente&nbsp;<?php echo ($_GET["nom"]);?> posee&nbsp;<?php echo ($_GET["nfac"]);?>&nbsp;Factura(s)<br />
<table width="680" cellspacing="1" cellpadding="1">
  <thead><tr style="background:#3B78B1;">
  	<th width="200">Numero de Factura</th>	
  	<th width="200">Fecha</th>
    <th width="200">Nº de Productos Facturados</th>
  </tr>					
  </thead>
...
<center><form method="post" action="librerias/php/consul_fec_fact.php" name="presu"> 
...
&nbsp;En este rango de fecha se realizaron <?php echo ($_GET["ffac"]);?>&nbsp;Factura(s)<br />
