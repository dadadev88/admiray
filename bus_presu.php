...
<body>
<div class="titulo">Buscar presupuesto (Reporte)</div> 
<form method="post" action="librerias/php/bus_presu.php" name="presu"> 
<table width="900" align="center">
  <tr>
    ...
    <td valign="bottom">N&ordm; de Presupuesto: &nbsp;&nbsp;&nbsp;
      <input type="text" name="cod_enc_pre" align="right" value="<?php echo $_GET['cod'];?>"/>
  ...
  <tr>
	...
	echo $_GET["res"];?><script>mostrar('er'); setTimeout(ocultar,1000,'er');</script> <? } ?></div> </td>
  </tr>
  <tr>
