...
<body>
<div class="titulo">Consultas de Orden de Compra</div><br />
<div class="titulo" style="width:600px;">Por Proveedor</div>
<br />
...
<form method="post" action="librerias/php/consul_cli_ord_comp.php" name="presu"> 
Cedula/RIF:<input name="rif" type="text" size="15" maxlength="50" align="right" value="<?php echo $_GET['cod'];?>" />
    &nbsp;&nbsp;<input width="20" height="20" type="image" src="imagenes/camera_test.png"/> 
</form>
<center>
  Proveedor&nbsp;<?php echo ($_GET["nom"]);?> posee&nbsp;<?php echo ($_GET["nod"]);?>&nbsp;Orden(es) de Compra<br />
<table width="680" cellspacing="1" cellpadding="1">
  <thead><tr style="background:#3B78B1;">
  	<th width="220">Numero de Orden de Compra</th>	
  	<th width="200">Fecha</th>
    <th width="200">Nº de Productos</th>
  </tr>					
  </thead>
...
<center><form method="post" action="librerias/php/consul_fec_ord_comp.php" name="presu"> 
...
&nbsp;En este rango de fecha se realizaron <?php echo ($_GET["fod"]);?>&nbsp;Orden(es) de Compra<br />
<center><table width="680" cellspacing="1" cellpadding="1">
  <thead><tr style="background:#3B78B1;">
  	<th width="200">Numero de Orden de Compra</th>	
  	<th width="200">Fecha</th>
