...
<body>
<div class="titulo">Consultas de Presupuestos de Compra</div><br />
...
<form method="post" action="librerias/php/consuL_cli_presu_comp.php" name="presu"> 
...
<center>
  Proveedor&nbsp;<?php echo ($_GET["nom"]);?> posee&nbsp;<?php echo ($_GET["npc"]);?>&nbsp;Presupuesto(s) de Compra<br />
<table width="680" cellspacing="1" cellpadding="1">
  <thead><tr style="background:#3B78B1;">
  	<th width="220">Numero de Presupuesto de Compra</th>	
...
<center><form method="post" action="librerias/php/consul_fec_pc.php" name="presu"> 
...
&nbsp;En este rango de fecha se realizaron <?php echo ($_GET["fpc"]);?>&nbsp;Presupuesto(s) de Compra<br />
<center><table width="680" cellspacing="1" cellpadding="1">
  <thead><tr style="background:#3B78B1;">
  	<th width="200">Numero de Presupuesto de Compra</th>	
  	<th width="200">Fecha</th>
