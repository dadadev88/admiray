...
<body>
<div class="titulo">Consultas de Recepciones de Mercancia</div><br />
...
<form method="post" action="librerias/php/consul_prov_recep.php" name="presu"> 
...
<center>
  Proveedor&nbsp;<?php echo ($_GET["nom"]);?> posee&nbsp;<?php echo ($_GET["nr"]);?>&nbsp;Recepcion(es) de Mercancia<br />
<table width="680" cellspacing="1" cellpadding="1">
  <thead><tr style="background:#3B78B1;">
  	<th width="220">Numero de Recepcion</th>	
...
<center><form method="post" action="librerias/php/consul_fec_recep.php" name="presu"> 
...
&nbsp;En este rango de fecha se realizaron <?php echo ($_GET["fr"]);?>&nbsp;Orden(es) de Compra<br />
<center><table width="680" cellspacing="1" cellpadding="1">
  <thead><tr style="background:#3B78B1;">
  	<th width="200">Numero de Recepcion</th>	
  	<th width="200">Fecha</th>
