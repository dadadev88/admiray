...
<img src="imagenes/inser_cli.png" id="agre" width="50" height="50" title="Agregar Cliente"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/Search.png" id="bus" width="50" height="50" title="Buscar Cliente"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/editar.png" width="50" height="50" id="edit" title="Modificar Cliente"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/eli_cliente.png" width="50" height="50" id="eli" title="Eliminar Cliente"/>					
</div>
<div id="provm" class="sub" >Proveedores<br />
<img src="imagenes/inser_prov.png" id="agre_prov" width="50" height="60" title="Agregar Proveedor"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/Search.png" id="bus_prov" width="50" height="50" title="Buscar Proveedor"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/editar.png" width="50" height="50" id="edit_prov" title="Modificar Proveedor"/>&nbsp;&nbsp;&nbsp;<img src="Imagenes/eli_prov.png" width="50" height="50" id="eli_prov" title="Eliminar Proveedor"/>					
</div>
<div id="prom"  class="sub">Productos<br />
<img src="imagenes/inser_pro.png" id="agre_pro" width="50" height="50" title="Agregar Producto"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/Search.png" id="bus_pro" width="50" height="50" title="Buscar Proveedor"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/editar.png" width="50" height="50" id="edit_pro"title="Modificar Proveedor"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/eli_pro.png" width="50" height="50" id="eli_pro" title="Eliminar Producto"/>				
</div>
...
<img src="imagenes/recep.png" id="recep" width="50" height="60" title="compra"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/Search.png" id="bus_recep" width="50" height="50"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/consul.png" width="50" height="50" id="consul_recep" title="Consultar Orden de Compra por proveedor o fecha"/>
  </tr>
</table></center>
</div>
<div id="stockm" class="sub" style="width:400px;">Stock de Producto<br />
<img src="imagenes/stock.png" id="stk" height="50" title="Ver Stock de Productos"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/pro_fal.png" id="pro_fal" height="50"  title="Productos Faltantes"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/pro_sob.png" id="pro_sob" height="50"  title="Productos Sobrante"/>&nbsp;&nbsp;&nbsp;<img src="imagenes/promasvendido.png" id="mas_ven" height="50"  title="Productos mas vendidos"/>				
</div>
<div id="mantenimientom" class="sub" style="width:200px;">Mantenimiento<br />
